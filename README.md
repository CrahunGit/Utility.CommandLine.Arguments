...
{
    var helpAttributes = Arguments.GetArgumentInfo(typeof(MigrationArguments));

    var maxLen = helpAttributes.Select(a => a.Property.PropertyType.Name).OrderByDescending(s => s.Length).FirstOrDefault()!.Length;
